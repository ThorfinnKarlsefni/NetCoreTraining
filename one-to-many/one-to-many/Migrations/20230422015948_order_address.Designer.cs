...
namespace one_to_many.Migrations
{
    ...
    [Migration("20230422015948_order_address")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("one_to_many.Addresses", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("T_Addresses", (string)null);
                });
            ...
            modelBuilder.Entity("one_to_many.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("one_to_many.OrgUnit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("one_to_many.Order", b =>
                {
                    b.HasOne("one_to_many.Addresses", "Addresses")
                        .WithOne("Order")
                        .HasForeignKey("one_to_many.Order", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("one_to_many.OrgUnit", b =>
                {
                    b.HasOne("one_to_many.OrgUnit", "Parent")
                        .WithMany("Children")
